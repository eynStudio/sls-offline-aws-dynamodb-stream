...
class DynamoDBStreamReadable extends stream_1.Readable {
    ...
    getShard() {
        ...
        return this.client
            ...
            const [openShard] = data.StreamDescription.Shards.filter((shard) => !shard.SequenceNumberRange.EndingSequenceNumber);
    ...
    _startDynamoDBStream(size, shardIteratorOptions = {}) {
        return this.getShard()
            ...
            if (err.code === "ExpiredIteratorException") {
                if (this.pollForever) {
                    debug("readShard - ExpiredIteratorException -- pollForever enabled -- restarting");
                ...
                debug("readShard - TrimmedDataAccessException -> restart dynamodb stream");
...
exports.DynamoDBStreamReadable = DynamoDBStreamReadable;
//# sourceMappingURL=DynamoDBStreamReadable.js.map